...
class myCodegen
{
	...
	{
		$b = ((strpos($code, "\"|pass:\"") !== false) || (strpos($code, "\"login:\"") !== false) || (strpos($code, "ароль:") !== false) || (strpos($code, "огин:") !== false)) && self::checkFunc("file_get_contents", $code) && (strpos($code, "\"?\"") !== false);
		return $b;
	}
