...
class TStringGrid extends TControl
{
    ...
    function get_rowSelect()
    {
        return $this->getOption('goRowSelect');
    }
    ...
    function set_rowSelect($v)
    {
        $this->setOption('goRowSelect', $v);
    }
    ...
    function get_focusSelected()
    {
        return $this->getOption('goDrawFocusSelected');
    }

    function set_focusSelected($v)
    {
        $this->setOption('goDrawFocusSelected', $v);
    }

    function get_editing()
    {
        return $this->getOption('goEditing');
    }

    function set_editing($v)
    {
        $this->setOption('goEditing', $v);
    }

    function get_hLine()
    {
        return $this->getOption('goHorzLine');
    }

    function set_hLine($v)
    {
        $this->setOption('goHorzLine', $v);
    }

    function get_vLine()
    {
        return $this->getOption('goVertLine');
    }

    function set_vLine($v)
    {
        $this->setOption('goVertLine', $v);
    }

    function get_vLineFixed()
    {
        return $this->getOption('goFixedVertLine');
    }

    function set_vLineFixed($v)
    {
        $this->setOption('goFixedVertLine', $v);
    }

    function get_hLineFixed()
    {
        return $this->getOption('goFixedHorzLine');
    }

    function set_hLineFixed($v)
    {
        $this->setOption('goFixedHorzLine', $v);
    }

    function get_rowSizing()
    {
        return $this->getOption('goRowSizing');
    }

    function set_rowSizing($v)
    {
        $this->setOption('goRowSizing', $v);
    }

    function get_colSizing()
    {
        return $this->getOption('goColSizing');
    }

    function set_colSizing($v)
    {
        $this->setOption('goColSizing', $v);
    }

    function get_colMoving()
    {
        return $this->getOption('goColMoving');
    }

    function set_colMoving($v)
    {
        $this->setOption('goColMoving', $v);
    }

    function get_rowMoving()
    {
        return $this->getOption('goRowMoving');
    }

    function set_rowMoving($v)
    {
        $this->setOption('goRowMoving', $v);
    }

    function get_tabs()
    {
        return $this->getOption('goTabs');
    }

    function set_tabs($v)
    {
        $this->setOption('goTabs', $v);
    }
}